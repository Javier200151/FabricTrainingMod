...
public enum ModArmorMaterials implements ArmorMaterial {
    ...
    // Have to have the same name in minecraft/textures/models/armor + layer_1 | + layer_2
    RUBY("ruby", 7, new int[]{2, 5, 7, 2}, 25, SoundEvents.ITEM_ARMOR_EQUIP_GOLD,
            0.0F, 0.0F, () -> {return Ingredient.ofItems(new ItemConvertible[]{ModItems.RUBY});
